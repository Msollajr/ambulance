...
public class history_adapter extends FirebaseRecyclerAdapter<history_model, history_adapter.myviewholder>
{

    public history_adapter(@NonNull FirebaseRecyclerOptions<history_model> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull final history_model models) {
